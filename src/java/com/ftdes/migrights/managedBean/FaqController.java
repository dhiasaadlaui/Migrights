...
import com.ftdes.migrights.sessionBean.FaqFacade;
...
public class FaqController implements Serializable {
    ...
    @EJB
    private com.ftdes.migrights.sessionBean.FaqFacade ejbFacade;
    ...
    public void create() {
        ...
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/Bundle").getString("FaqCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/Bundle").getString("FaqUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/Bundle").getString("FaqDeleted"));
        if (!JsfUtil.isValidationFailed()) {
    ...
    public Faq getFaq(java.lang.Integer id) {
