...
import com.ftdes.migrights.sessionBean.AdminFacade;
...
public class AdminController implements Serializable {
    ...
    @EJB
    private com.ftdes.migrights.sessionBean.AdminFacade ejbFacade;
    ...
    public void create() {
     ...
     public void updateLogedAccount() {
        this.selected= loginctrl.getLogedAdmin();
